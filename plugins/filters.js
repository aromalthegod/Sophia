...
const array = ['amitt','anoo','appi','bye bye','chug niet','enthada','fek u','Germu','hii gooys','Hii guys','Kazhicho','kuthum','okk','puda thyli','sed aayi','somu','uff','umbi','umma']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
